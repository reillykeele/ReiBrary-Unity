...
namespace ReiBrary.Splines
{
    ...
    /// </summary>
    [AddComponentMenu("Splines/Spline Animate Curve")]
    [ExecuteInEditMode]
    public class SplineAnimateCurve : SplineComponent
    {
        /// <summary>
        ...
        [SerializeField, Tooltip("The method used to animate the GameObject along the spline.\n" +
                                 ...
                                 "Curve - The spline is traversed based on the given animation curve.")]
        Method m_Method = Method.Curve;
        ...
        void OnValidate()
        {
            ...
            if (Easing != EasingMode.None)
            {
                ...
                Debug.LogWarning("Must use EasingMode.None with SplineCurveAnimate. Use the animation curve to ease.");
            }
