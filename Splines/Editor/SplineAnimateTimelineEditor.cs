...
{
    [CustomEditor(typeof(SplineAnimateTimeline))]
    [CanEditMultipleObjects]
    class SplineAnimateTimelineEditor : UnityEditor.Editor
    {
        ...
        SplineAnimateTimeline m_SplineAnimate;
        ...
        SplineAnimateTimeline[] m_Components;

        void OnEnable()
        {
            m_SplineAnimate = target as SplineAnimateTimeline;
            ...
            m_Components = targets.Select(x => x as SplineAnimateTimeline).Where(y => y != null).ToArray();

            foreach (var animate in m_Components)
            {
                if (animate.Container != null)
                    animate.RebuildSplinePath();
            }
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            methodField.RegisterValueChangeCallback((_) => { RefreshMethodParamFields((SplineAnimateTimeline.Method)m_MethodProperty.enumValueIndex); });
            RefreshMethodParamFields((SplineAnimateTimeline.Method)m_MethodProperty.enumValueIndex);
        ...
        void RefreshMethodParamFields(SplineAnimateTimeline.Method method)
        {
            ...
            if (method == (int)SplineAnimateTimeline.Method.Timeline)
            {
        ...
        void OnObjectAxisFieldChange(ChangeEvent<Enum> changeEvent, SerializedProperty axisProp, SerializedProperty otherAxisProp)
        {
            ...
            var newValue = (SplineAnimateTimeline.AlignAxis)changeEvent.newValue;
            var previousValue = (SplineAnimateTimeline.AlignAxis)changeEvent.previousValue;

            // Swap axes if the picked value matches that of the other axis field
            if (newValue == (SplineAnimateTimeline.AlignAxis)otherAxisProp.enumValueIndex)
            {
        ...
        void OnPlayClicked()
        {
            ...
            {
                m_SplineAnimate.RebuildSplinePath();
        ...
        static void DrawSplineAnimateGizmos(SplineAnimateTimeline splineAnimate, GizmoType gizmoType)
        {
